                    ...
                    <div class="grid-body">
                        ...
                        <div class="row">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu ">
                                    <li><a class="dropdown-item" id="reset" href="javascript:void(0)">None</a></li>
                                    <li><a class="dropdown-item location" data-value="location" href="javascript:void(0)">Location</a></li>
                                                ...
                                                <table class="table table-hover  ">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="name">
                                                            ...
                                                            <strong>{{ucwords($doctor["first_name"])}} {{ucwords($doctor["last_name"])}} </strong></a> <br>
